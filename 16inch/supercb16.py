...
#withdraw 14 from spot 2
    ...
    time.sleep(.5)
    pg.click()
    pg.moveTo(bank_3[0],bank_3[1],.5+move_noise,pg.easeInQuad)
    time.sleep(.5)
    pg.click()
#withdraw 14 from spot 2
    pg.moveTo(bank_4[0]+noise,bank_4[1]+noise,.5+move_noise,pg.easeInQuad)
    time.sleep(.5)
    pg.click()
...
#escape bank tab
    ...
    pg.press('esc')
#click inv 14
    pg.moveTo(torstol[0]+noise,torstol[1]+noise,.5+move_noise,pg.easeInQuad)
    time.sleep(.5)
    pg.click()
#click inv 14
