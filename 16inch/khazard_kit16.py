...
click_bank = [ 1273 , 292 ]
deposit_kit = [ 1531 , 387 ]
withdraw_plank = [ 1018 , 162 ]
workbench = [ 1332 , 428 ]
...
def smith():
    ...
    pg.moveTo(deposit_kit[0]+random.randint(-1,1),deposit_kit[1]+random.randint(-1,1),.2+random.random()/2,pg.easeInQuad)
    pg.click()
    ...
    pg.moveTo(workbench[0]+random.randint(-2,2),workbench[1]+random.randint(-5,5),.2+random.random()/2,pg.easeInQuad)
    pg.click()
    time.sleep(5+random.random()/10)
    ...
    time.sleep(32+random.random()/10)
