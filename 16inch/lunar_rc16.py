...
essence = [ 1017 , 162 ]
p1,p2,p3 = [ 1526 , 349 ],[ 1567 , 351 ],[ 1608 , 350 ]
flax = [ 1151 , 89 ]
altar1 = [ 942 , 196 ]
craft_altar = [ 1274 , 373 ]
...
for i in tqdm(range(iters_)):
    ...
    pyautogui.moveTo(altar[0]+random.randint(-1,1), altar[1]+random.randint(-1,1), duration=(.3+(random.random()/10)))
    pyautogui.click()
    time.sleep(16.2+(random.random()/5))
