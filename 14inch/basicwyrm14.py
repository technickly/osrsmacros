...
def run_lap():
    ...
    if random.randint(0,20) == 1:
        time.sleep(1+random.random())
    pg.moveTo(rope_2[0]+n2,rope_2[1]+n1,.5+move_noise,pg.easeInQuad)
    pg.click()
    time.sleep(16.5+random.random()/10.)
    if random.randint(0,20) == 1:
        time.sleep(1+random.random())
    pg.moveTo(rope_3[0]+n2,rope_3[1]+n1,.5+move_noise,pg.easeInQuad)
    pg.click()
    time.sleep(12.5+random.random()/10.)
    if random.randint(0,20) == 1:
        time.sleep(1+random.random())
